...
#已经被重写了.会触发下一层的 base_cmn的_prepare_feature
    def _prepare_feature(self, fc_feats, att_feats, att_masks):
        return fc_feats

    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, state, prefix_kv, output_logsoftmax=1):
        # 'it' contains a word index
        xt = self.embed(it)

        output, state = self.core(xt, fc_feats, att_feats, p_att_feats, state, att_masks,prefix_kv)
    ...
    # def _sample_beam(self, fc_feats, att_feats,view_ids,visit_ids, att_masks=None, opt={}):
    ...
    #
    #     p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, view_ids,visit_ids, att_masks)
    #
